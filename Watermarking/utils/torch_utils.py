...
#     Args:
#         message: 1D 张量，原始水印
#         decoded_message: 1D 张量，解码水印
#     Returns:
#         error_rate: 张量，错误率
#     """
#     assert message.dim() == 1, "Expected 1D tensor for message"
#     assert decoded_message.dim() == 1, "Expected 1D tensor for decoded_message"
#     assert message.shape == decoded_message.shape, "Shape mismatch"
#
#     message = message.gt(0)
#     decoded_message = decoded_message.gt(0)
#     error_rate = (message != decoded_message).float().mean()
#     return error_rate
