...
class attrsImgDataset(Dataset):
    def __init__(self, path, image_size, attr_path="celeba"):
        ...
        if attr_path[0: len("celebahq")] != "celebahq":
            self.attr_path = "E:/scpcode/WM/network/noise/stargan/list_attr_celeba.txt"
        else:
            self.attr_path = "E:/scpcode/WM/network/noise/stargan/CelebAMask-HQ-attribute-anno.txt"
